...
const emojiOneInputCheck = document.querySelector("#emoji-one-input-check");
...
emojiOneInput.addEventListener("change", () => {
  // console.log(isEmoji(emojiOneInput.innerText))
  // if (isEmoji(emojiOneInput.innerText)) {
  //   circleButtons[0].innerText = emojiOneInput.value;
  //   emojiOneInputCheck.innerText = "All good!"
  //   emojiOneInputCheck.style.color = "lightgreen"
  // }
